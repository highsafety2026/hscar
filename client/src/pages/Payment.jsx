          ...
          {step === 0 && (
            <div className="wizard-step step-category">
              ...
              <p className="step-description">
                {language === 'ar' ? 'الأسعار تختلف حسب نوع السيارة' : 'Prices vary based on vehicle type'}
              </p>
              ...
              <div className="payment-layout">
                ...
                <div className="order-summary">
                  ...
                  <div className="summary-item">
                    ...
                    <span className="summary-value">{selectedCategory?.emoji} {selectedCategory?.label}</span>
                  </div>
